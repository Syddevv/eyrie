...
export default function GoalsScreen() {
  ...
  const highlightedGoal = activeGoals.find((goal) => !goal.isCompleted) ?? activeGoals[0] ?? null;
        ...
        <View style={styles.headerBlock}>
          <View style={styles.headerRow}>
            <View>
              ...
              <Text style={[styles.subtitle, pageStyles.mutedText]}>Make saving feel visible and deliberate</Text>
            </View>
        ...
        <ScrollView
          ...
          <View style={[styles.summaryCard, pageStyles.summaryCard, shadows.card]}>
            <View style={styles.summaryTopRow}>
              ...
              <View style={styles.summaryRight}>
                <View style={styles.summaryMiniStat}>
                  <Text style={[styles.summaryMiniValue, pageStyles.summaryTitleText]}>{overview.activeGoalsCount}</Text>
                  <Text style={[styles.summaryMiniLabel, pageStyles.summaryLabelText]}>active</Text>
                </View>
                <View style={styles.summaryMiniStat}>
                  <Text style={[styles.summaryMiniValue, pageStyles.summaryTitleText]}>{overview.completedGoalsCount}</Text>
                  <Text style={[styles.summaryMiniLabel, pageStyles.summaryLabelText]}>done</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.summaryProgressRow}>
              ...
              <Text style={[styles.summaryProgressValue, pageStyles.summaryTitleText]}>
            ...
            <View style={[styles.summaryTrack, pageStyles.summaryTrack]}>
              <View style={[styles.summaryFillWrap, { width: `${overview.overallProgress}%` }]}>
                <LinearGradient
          ...
          {!activeGoals.length ? (
            <View style={[styles.emptyCard, pageStyles.chipCard, shadows.soft]}>
              ...
              <Text style={[styles.emptyText, pageStyles.mutedText]}>
                Goals track progress separately from budgets and expenses, so every contribution feels intentional.
              </Text>
              <Pressable style={[styles.emptyButton, pageStyles.coachButton]} onPress={() => router.push("/new-savings-goal-modal")}>
                ...
                <Pressable
                  ...
                  <View style={styles.goalTopRow}>
                    <View style={styles.goalIdentity}>
                      <View style={[styles.goalIconWrap, { backgroundColor: `${goal.color ?? "#1495FF"}22` }]}>
                    ...
                    <View
                      style={[
                        styles.goalFill,
                        {
                          ...
                          backgroundColor: goal.metrics.isCompleted ? "#10B981" : goal.color ?? "#1495FF",
                        },
                      ]}
                    />
                  </View>
                  ...
                  <View style={styles.goalStatusRow}>
                    <Text style={[styles.goalAchieved, pageStyles.mutedText]}>
                      {goal.metrics.isCompleted ? "Completed" : `${Math.round(goal.metrics.progressPercentage)}% funded`}
                    </Text>
                  ...
                  <View style={styles.contributionsRow}>
                    {goal.contributions.slice(0, 3).map((entry) => (
                      <View key={entry.id} style={[styles.contributionChip, pageStyles.chip]}>
                        <Text style={[styles.contributionText, pageStyles.title]}>
                          {`+${formatCurrency(entry.amount)}`}
                        </Text>
                        <Text style={[styles.contributionMeta, pageStyles.mutedText]}>
                    ...
                    {!goal.contributions.length ? (
                      <View style={[styles.contributionChip, pageStyles.chip]}>
                        <Text style={[styles.contributionText, pageStyles.title]}>No contributions yet</Text>
                      </View>
                    ) : null}
                  </View>
                </Pressable>
            ...
            <View style={[styles.coachCard, pageStyles.coachCard]}>
              <View style={styles.coachTopRow}>
                ...
                <View style={styles.coachTextBlock}>
                  <Text style={[styles.coachTitle, pageStyles.coachTitle]}>Savings Insight</Text>
              ...
              <Pressable
                ...
                onPress={() =>
                  router.push({ pathname: "/add-contribution-modal", params: { goalId: highlightedGoal.id } })
                }>
                ...
                <Pressable
                  ...
                  onPress={() =>
                    router.push({
                      ...
                      params: { suggestedName: item.title, suggestedIconName: item.iconName, suggestedColor: item.color },
                    })
                  }>
                  <View style={[styles.suggestedIconWrap, { backgroundColor: item.color }]}>
...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: fontFamilies.sans, fontSize: 24, lineHeight: 30, fontWeight: fontWeights.bold },
  subtitle: { marginTop: 4, fontFamily: fontFamilies.sans, fontSize: 16, lineHeight: 22 },
  headerAction: {
    width: 40,
    height: 40,
  ...
  summaryMiniValue: { fontFamily: fontFamilies.sans, fontSize: 15, lineHeight: 20, fontWeight: fontWeights.bold },
  summaryMiniLabel: { fontFamily: fontFamilies.sans, fontSize: 12, lineHeight: 16 },
  summaryAmount: {
    marginTop: 10,
  ...
  summaryProgressRow: { marginTop: 18, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12 },
  summaryProgressLabel: { fontFamily: fontFamilies.sans, fontSize: 15, lineHeight: 20 },
  summaryProgressValue: { fontFamily: fontFamilies.sans, fontSize: 15, lineHeight: 20, fontWeight: fontWeights.bold },
  summaryTrack: { marginTop: 14, height: 12, borderRadius: radius.full, overflow: "hidden" },
  summaryFillWrap: { height: "100%" },
  summaryFill: { width: "100%", height: "100%" },
  goalsList: { gap: 16, marginTop: 18 },
  goalCard: { borderRadius: 28, borderWidth: 1, paddingHorizontal: 18, paddingVertical: 18 },
  goalTopRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  goalIdentity: { flexDirection: "row", alignItems: "center", gap: 12, flex: 1 },
  goalIconWrap: { width: 48, height: 48, borderRadius: radius.full, alignItems: "center", justifyContent: "center" },
  goalTextBlock: { flex: 1 },
  goalTitle: { fontFamily: fontFamilies.sans, fontSize: 18, lineHeight: 24, fontWeight: fontWeights.bold },
  goalTarget: { marginTop: 2, fontFamily: fontFamilies.sans, fontSize: 14, lineHeight: 18 },
  goalAmountsRow: { marginTop: 16, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  goalSaved: { fontFamily: fontFamilies.sans, fontSize: 20, lineHeight: 26, fontWeight: fontWeights.bold },
  goalAmountTarget: { fontFamily: fontFamilies.sans, fontSize: 14, lineHeight: 18 },
  goalTrack: { marginTop: 14, height: 10, borderRadius: radius.full, overflow: "hidden" },
  goalFill: { height: "100%", borderRadius: radius.full },
  goalStatusRow: { marginTop: 12, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12 },
  goalAchieved: { fontFamily: fontFamilies.sans, fontSize: 13, lineHeight: 17 },
  goalRemaining: { fontFamily: fontFamilies.sans, fontSize: 13, lineHeight: 17, fontWeight: fontWeights.medium },
  goalDivider: { marginTop: 16, height: 1 },
  recentLabel: { marginTop: 14, fontFamily: fontFamilies.sans, fontSize: 13, lineHeight: 17 },
  contributionsRow: { marginTop: 10, flexDirection: "row", flexWrap: "wrap", gap: 8 },
  contributionChip: { borderRadius: 18, paddingHorizontal: 12, paddingVertical: 10 },
  contributionText: { fontFamily: fontFamilies.sans, fontSize: 13, lineHeight: 17, fontWeight: fontWeights.bold },
  contributionMeta: { marginTop: 2, fontFamily: fontFamilies.sans, fontSize: 11, lineHeight: 14 },
  coachCard: { marginTop: 24, borderRadius: 28, borderWidth: 1, padding: 16 },
  coachTopRow: { flexDirection: "row", gap: 12 },
  coachAvatarFrame: { width: 48, height: 48, borderRadius: radius.full, overflow: "hidden" },
  coachAvatar: { width: "100%", height: "100%" },
  coachTextBlock: { flex: 1 },
  coachTitle: { fontFamily: fontFamilies.sans, fontSize: 17, lineHeight: 22, fontWeight: fontWeights.bold },
  coachText: { marginTop: 4, fontFamily: fontFamilies.sans, fontSize: 14, lineHeight: 20 },
  coachButton: { marginTop: 14, borderRadius: 20, alignItems: "center", justifyContent: "center", minHeight: 46 },
  coachButtonText: { color: "#FFFFFF", fontFamily: fontFamilies.sans, fontSize: 15, lineHeight: 20, fontWeight: fontWeights.bold },
  suggestedSection: { marginTop: 24 },
  suggestedTitle: { fontFamily: fontFamilies.sans, fontSize: 18, lineHeight: 24, fontWeight: fontWeights.bold },
  suggestedRow: { gap: 12, paddingTop: 14, paddingRight: 14 },
  suggestedChip: { minWidth: 138, borderRadius: 24, borderWidth: 1, paddingHorizontal: 14, paddingVertical: 14, gap: 12 },
  suggestedIconWrap: { width: 38, height: 38, borderRadius: radius.full, alignItems: "center", justifyContent: "center" },
  suggestedChipText: { fontFamily: fontFamilies.sans, fontSize: 15, lineHeight: 20, fontWeight: fontWeights.bold },
  emptyCard: { marginTop: 24, borderRadius: 28, borderWidth: 1, padding: 20, alignItems: "center" },
  emptyMascot: { width: 120, height: 120 },
  emptyTitle: { marginTop: 10, textAlign: "center", fontFamily: fontFamilies.sans, fontSize: 20, lineHeight: 26, fontWeight: fontWeights.bold },
  emptyText: { marginTop: 8, textAlign: "center", fontFamily: fontFamilies.sans, fontSize: 14, lineHeight: 20 },
  emptyButton: { marginTop: 18, minHeight: 46, borderRadius: 20, alignItems: "center", justifyContent: "center", paddingHorizontal: 22 },
  emptyButtonText: { color: "#FFFFFF", fontFamily: fontFamilies.sans, fontSize: 15, lineHeight: 20, fontWeight: fontWeights.bold },
});
