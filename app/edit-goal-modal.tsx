...
export default function EditGoalModal() {
  ...
  useEffect(() => {
    ...
    setIconType(
      (goal.iconType ?? "vector") as "vector" | "emoji" | "uploaded_image",
    );
  ...
  // Hide floating bottom nav while this modal is open
  useEffect(() => {
  ...
  const monthlyTarget =
    parsedTargetAmount > 0
      ? parsedTargetAmount / Math.max(1, Math.ceil(dayDifference / 30))
      : 0;
  ...
  const handleSave = async () => {
    ...
    if (!isSaveEnabled) {
      Alert.alert(
        ...
        "Add a valid goal name and target amount.",
      );
      return;
    }
      ...
      <View style={[styles.overlay, ui.overlay]}>
        ...
        >
              ...
              >
                <Text
                  style={[
                    styles.dateValue,
                    ui.title,
                    isKeyboardOpen && styles.dateValueCompact,
                  ]}
                >
                  ...
                  (value) => (
                    <Pressable
                      ...
                      style={[
                        ...
                        iconType === value && ui.selectedCard,
                      ]}
          ...
          <View style={styles.footerActions}>
            <Pressable
              style={[styles.footerButton, ui.card]}
              onPress={closeEditFlow}
            >
            ...
            <Pressable
              style={[
                styles.footerButton,
                isSaveEnabled ? ui.primaryButton : ui.disabledButton,
              ]}
