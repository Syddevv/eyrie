...
export default function AddBankAccountModal() {
  ...
  const returnTo = Array.isArray(params.returnTo) ? params.returnTo[0] : params.returnTo || '/add-bank-card-method-modal';
      ...
      <View style={[styles.overlay, ui.overlay]}>
        ...
        <View
          ...
          <Pressable
            ...
            onPress={() => router.replace({ pathname: returnTo, params: { returnTo: '/add-payment-method-modal', parentTo } })}>
          ...
          <Text style={[styles.note, ui.note]}>
            For security purposes, card details are optional because your bank account will not be directly connected to the app.
          </Text>
          ...
          <View style={styles.row}>
            <View style={styles.halfField}>
              <Text style={[styles.label, ui.label]}>Expiry Date (Optional)</Text>
              <View style={[styles.fieldSurface, ui.fieldSurface]}>
                <TextInput
                  value={expiryDate}
