...
export const walletBrandThemes = {
  gcash: {
    ...
    primary: "#0057FF",
    secondary: "#007DFF",
    gradient: ["#0057FF", "#0039A6"],
    text: "#FFFFFF",
    glow: "rgba(0, 125, 255, 0.35)",
  },
  maya: {
    id: "maya",
    name: "Maya",
    primary: "#00D17B",
    secondary: "#00B86B",
    gradient: ["#00D17B", "#007A4D"],
    text: "#FFFFFF",
    glow: "rgba(0, 209, 123, 0.35)",
  },
  gotyme: {
    id: "gotyme",
    name: "GoTyme",
    primary: "#12C7C2",
    secondary: "#18D6D1",
    gradient: ["#12C7C2", "#0E8F96"],
    text: "#1C1C1E",
    glow: "rgba(18, 199, 194, 0.35)",
  ...
  shopeepay: {
    ...
    primary: "#F1582C",
    secondary: "#FF6B3D",
    gradient: ["#F1582C", "#C63F19"],
    text: "#FFFFFF",
    glow: "rgba(241, 88, 44, 0.35)",
  },
  lazadawallet: {
    id: "lazadawallet",
    name: "Lazada Wallet",
  ...
  bpi: {
    ...
    primary: "#A61E22",
    secondary: "#C62828",
    gradient: ["#A61E22", "#6E1013"],
    text: "#FFFFFF",
    glow: "rgba(166, 30, 34, 0.35)",
  },
  metrobank: {
    id: "metrobank",
    name: "Metrobank",
  ...
  landbank: {
    ...
    primary: "#1D7F3F",
    secondary: "#2BA84A",
    gradient: ["#1D7F3F", "#125628"],
    text: "#FFFFFF",
    glow: "rgba(29, 127, 63, 0.35)",
  },
  rcbc: {
    id: "rcbc",
    name: "RCBC",
